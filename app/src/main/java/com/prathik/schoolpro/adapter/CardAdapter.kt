...
class CardAdapter(val context:Context,val cardList:ArrayList<CardInfo>): RecyclerView.Adapter<CardAdapter.CardHolder>() {

    val cardTypeIcon:IntArray = intArrayOf(R.drawable.ic_visa,R.drawable.ic_mastercard,  R.drawable.ic_rupay , R.drawable.ic_visa_electron,  R.drawable.ic_maestro)

    val bankIcon:IntArray = intArrayOf(R.drawable.allahabad,
        R.drawable.andra,
        R.drawable.axisbank ,
        R.drawable.bandan,
        R.drawable.bob,
    ...
    override fun onBindViewHolder(holder: CardAdapter.CardHolder, position : Int) {
       var card=cardList[position]
        ...
        holder.cardNumber.text=card.cardNo
    ...
    private fun setCardTypeIcon(type:String,holder: CardAdapter.CardHolder){
        ...
        when(type){
            cardTypes[0] ->  { holder.cardIcon.setImageResource(cardTypeIcon[0])}
            cardTypes[1] ->  { holder.cardIcon.setImageResource(cardTypeIcon[1])}
            cardTypes[2] ->  { holder.cardIcon.setImageResource(cardTypeIcon[2])}
            cardTypes[3] ->  { holder.cardIcon.setImageResource(cardTypeIcon[3])}
            cardTypes[4] ->  { holder.cardIcon.setImageResource(cardTypeIcon[4])}
        }
